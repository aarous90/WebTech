<?php
	...
	include 'C:/xampp/htdocs/X/core/init.php';
	include 'C:/xampp/htdocs/X/gameFunction/databaseAccess.php';
	include 'C:/xampp/htdocs/X/gameFunction/checkPlayerAndCreateGame.php';
