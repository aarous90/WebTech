<?php
	...
	function change_password($user_id, $password){
		...
		mysql_query("UPDATE tlreg SET password ='$password' WHERE user_id = '$user_id'") or die (mysql_error());
	}
	...
	function register_user($register_data) {
		...
		mysql_query("INSERT INTO tlreg($fields) VALUES($data)") or die (mysql_error());
		...
		$message .=	'<p><a href="localhost/activate.php?email='.$register_data['email'].'&email_code='.$register_data['email_code'].'">localhost/activate.php?email='.$register_data['email'].'&email_code='.$register_data['email_code'].'</a></p>';
